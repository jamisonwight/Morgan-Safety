...
export default function FeatureContent({ data, showForm, setShowForm, index }) {
    ...
    const styles =  {
        main: `tline after:tline-after tline-orange after:tline-orange-after w-full bg-black-100 z-10 alt-order`,
        container: `w-full relative left-[50%] translate-x-[-50%] flex px-10 sm:py-[0] max-w-[100%]`,
        image: {
            main: `flex-[50%] flex flex-col flex-[50%] justify-center items-center tline-marker-parent`,
            content_wrap: `w-full flex flex-col justify-center items-center relative block\
            lg:sticky lg:top-[100px] lg:h-[calc(100vh_-_97.5px)]`,
            img: `w-full img img-cyan order-item-2`,
        },
        content: {
            main: `flex flex-col justify-center items-center flex-[50%] py-[80px]`,
            content_container: `max-w-[500px]`,
            title: {
                main: `w-full flex justify-center mt-[30px] order-item-2`,
                inner_title: `heading-4-lg !font-normal text-cyan`,
            },
            subtitle: `heading-3 text-orange block pb-[10px]`,
            copy: `paragraph-2 text-orange [&>p]:pb-[20px]`,
            btn_container: `flex flex-wrap mt-[40px]`,
